        ...
        try {
            ...
            if(isset($emailAddresses) && !empty($emailAddresses) && filter_var($emailAddresses, FILTER_VALIDATE_EMAIL)) {
                ...
                foreach ($emails as $email) {
                    Mail::to($email)->send(new EmailPl($dataArray));
                }
        ...
        if(count($query)>0){
            ...
            if($status == 'A') {
                ...
                if ($snd == '1') {
                    ...
                    $msg = "You Failed to Approve the PL Rec Maintenance No ".$doc_no;
                ...
                if ($snd == '1') {
                    ...
                    $msg = "You Failed to Make a Revise Request on PL Rec Maintenance No. ".$doc_no;
