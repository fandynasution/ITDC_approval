...
class SalesRdglController extends Controller
{
    ...
    public function changestatus($entity_cd='', $doc_no='', $status='', $level_no='')
    {
        ...
        if(count($query)>0){
            ...
            $msg = 'There is no Request to Approval Sales Booking Discount No. '.$doc_no ;
            $notif = 'Restricted !';
            $st  = 'OK';
            $image = "double_approve.png";
            $msg1 = array(
    ...
    public function update(Request $request)
    {
        ...
        if ($status == "A") {
            $desc = "Approved the Approval Sales Booking Discount";
            $descstatus = "Approved";
            $imagestatus = "approved.png";
        } else if ($status == "R") {
            $desc = "Made a Revise Request on Approval Sales Booking Discount";
            $descstatus = "Revised";
            $imagestatus = "revise.png";
        } else {
            $desc = "Cancelled the Approval Sales Booking Discount";
