...
{
    public function LandMasterApprovalMail(Request $request) {
        ...
        try {
            ...
            if(isset($emailAddresses) && !empty($emailAddresses) && filter_var($emailAddresses, FILTER_VALIDATE_EMAIL)) {
                ...
                foreach ($emails as $email) {
                    Mail::to($email)->send(new LandMasterMail($dataArray));
                }
    ...
    public function changestatus($status='', $entity_cd='', $doc_no='', $level_no='')
    {
        ...
        ->get();
        if(count($query)>0){
            $msg = 'You Have Already Made a Request to Land Master Permit Location No. '.$doc_no ;
            $notif = 'Restricted !';
            $st  = 'OK';
        ...
        return view('emails/landmaster/action', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        if($status == 'A') {
            ...
            if ($sth == true) 
            {
                ...
                $msg = "You Failed to Approve the Land Master Permit Location No ".$doc_no;
            ...
            if ($sth == true) {
                ...
                $msg = "You Failed to Cancel the Land Master Permit Location No. ".$doc_no;
